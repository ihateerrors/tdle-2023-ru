(function(r) {
    ...
    var u = function(t, e, i, r, n) {
        ...
        if (i && typeof i === "object") {
            if (r !== void 0 && "context"in n && n.context === void 0)
                n.context = r;
    ...
    x.extend(g.prototype, r, {
        ...
        hasChanged: function(t) {
            if (t == null)
                return !x.isEmpty(this.changed);
            return x.has(this.changed, t)
        },
        changedAttributes: function(t) {
            if (!t)
                return this.hasChanged() ? x.clone(this.changed) : false;
        ...
        save: function(t, e, i) {
            ...
            i.success = function(t) {
                ...
                if (e && !s.set(e, i))
                    return false;
                if (a)
                    a.call(i.context, s, t, i);
                s.trigger("sync", s, t, i)
            }
            ;
            G(this, i);
            if (r && n)
                this.attributes = x.extend({}, o, r);
    ...
    x.extend(A.prototype, r, {
        ...
        _ensureElement: function() {
            if (!this.el) {
                ...
                if (this.id)
                    t.id = x.result(this, "id");
                if (this.className)
                    t["class"] = x.result(this, "className");
    ...
    var $ = function(i, r, t, n) {
        x.each(t, function(t, e) {
            if (r[e])
                i.prototype[e] = H(r, t, e, n)
        })
    };
    var C = function(e, t) {
        if (x.isFunction(e))
            return e;
        if (x.isObject(e) && !t._isModel(e))
            return R(e);
        if (x.isString(e))
            return function(t) {
                return t.get(e)
